...
import { EventRecord, ContractExecResult, SignedBlock, AccountId, WeightV2 } from '@polkadot/types/interfaces';
 ...
 */
declare const formatBalance: (api: ApiPromise | undefined, value?: BN, options?: BalanceFormatterOptions) => string;
 ...
 */
declare const transferBalance: (api: ApiPromise, fromAccount: IKeyringPair | string, toAddress: string | AccountId, amount: BN, statusCb?: Callback<ISubmittableResult>) => Promise<unknown>;
/**
 * Transfers all available tokens from one account to another.
 */
declare const transferFullBalance: (api: ApiPromise, fromAccount: IKeyringPair | string, toAddress: string | AccountId, keepAlive?: boolean, statusCb?: Callback<ISubmittableResult>) => Promise<unknown>;
...
export { BalanceData, BalanceFormatterOptions, ContractTxResult, PolkadotBalanceFormatterOptions, SubstrateChain, SubstrateDeployment, SubstrateExplorer, SubstrateWallet, SubstrateWalletPlatform, UseInkathonError, UseInkathonErrorCode, UseInkathonProvider, UseInkathonProviderContext, UseInkathonProviderContextType, UseInkathonProviderProps, accountArraysAreEqual, accountsAreEqual, alephzero, alephzeroSigner, alephzeroTestnet, allSubstrateChains, allSubstrateWallets, astar, contractCallDryRun, contractQuery, contractTx, decodeOutput, deployContract, development, enableWallet, formatBalance, getAbiMessage, getBalance, getDeployment, getDeploymentContract, getGasLimit, getMaxGasLimit, getSubstrateChain, getSubstrateWallet, initPolkadotJs, isWalletInstalled, nightly, nova, polkadotjs, registerDeployment, registerDeployments, rococo, shibuya, shiden, subwallet, talisman, transferBalance, transferFullBalance, unwrapResultOrDefault, unwrapResultOrError, useBalance, useContract, useInkathon, useRegisteredContract, watchBalance };
